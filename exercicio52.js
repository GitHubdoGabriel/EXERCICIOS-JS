/*52)Quando temos um objeto e manipulamos seus atributos, adicionando, atualizando ou removendo-os, estamos
...
function removerPropriedade(objeto1, ...elementoObj){
    const i = {...objeto1}
    delete i[elementoObj]
    return i
}
